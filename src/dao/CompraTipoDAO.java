...
public class CompraTipoDAO {
    ...
    public List<CompraTipo> read() {
        ...
        try {
            ...
            stmt = connect.prepareStatement("SELECT * FROM COMPRATIPO ORDER BY CODIGO ASC");
    ...
    public CompraTipo readLine(CompraTipo c) {
        ...
        try {
            ...
            String sql = "SELECT * FROM COMPRATIPO WHERE UPPER (DESCRICAO) LIKE '%" + c.getDescricao() + "%'";
